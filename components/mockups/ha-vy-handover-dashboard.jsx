...
/* Dashboard — CL-122/123/124/125/126/127
   Coworker redesigned: stat row + session cards with inline Q&A (no A/B split) */
...
/* ═══ COWORKER (redesigned — stat row + session cards) ═══ */
...
function CoworkerActive() {
  ...
  return (<div className="max-w-3xl mx-auto p-6">
    <div className="mb-6"><h1 className="text-xl font-semibold text-gray-900 tracking-tight">Welcome back, Tr\u1ea7n H\u1eefu Nam</h1><p className="text-[12px] text-gray-500 mt-1">Coworker \u00b7 Engineering</p></div>
      ...
      {hasActivity && (
        <div className="px-4 pb-4 border-t border-gray-100 pt-3">
          <div className="flex gap-3 mb-2.5 text-[10px]">
            {s.answersReady > 0 && <span className="text-emerald-600 inline-flex items-center gap-1"><CheckCircle2 className="w-3 h-3" />{s.answersReady} answer{s.answersReady > 1 ? "s" : ""} ready</span>}
