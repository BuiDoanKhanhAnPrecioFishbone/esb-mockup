...
function CardRow({ card, linked, showProgress, canManage, dismissedFlags, onDismissFlag, primaryModuleOf, selectedCard, onSelectCard }) {
  ...
  // §4.2 — no drag handle, no "Move to", no attachment icon. §4.1 — flags shown as orange "Detects" badges.
