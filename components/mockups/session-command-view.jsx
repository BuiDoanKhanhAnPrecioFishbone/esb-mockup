...
/* ═══════════════════════════════════════════════════════════════════
   ...
   3-tab Prepare-first build:
     ...
     · Mock data filled with Minh Lê session specifics:
       Trello board 'Backend Platform', Kafka/CQRS/GraphQL architecture,
       payment + inventory services, named stakeholder context.
   ═══════════════════════════════════════════════════════════════════ */
...
/* ─── Mock data · Minh Lê's Trello board 'Backend Platform' ────────── */
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="mt-2">
          <SourceRow icon={Trello} name="Trello · Backend Platform" detail="In Progress / Review / Done · thin cards skipped · labels prioritized" status="active" subDetail="4-layer filter" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        <SectionLabel>Source</SectionLabel>
        <div className="mt-2">
          <SourceRow icon={Trello} name="Trello · Backend Platform" detail={`${CRAWL_SUMMARY.totalKept} items kept · ${CRAWL_SUMMARY.thinSkipped} skipped · ${CRAWL_SUMMARY.redacted} redacted`} status="done" subDetail="4-layer filter" />
        </div>
      </div>
  ...
  return (
    <div className="space-y-5">
      <div>
        <SectionLabel>Source</SectionLabel>
        <div className="mt-2">
          <SourceRow icon={Trello} name="Trello · Backend Platform"
            detail={isSeeding
    ...
    <aside className="space-y-4">
      ...
      <div>
        ...
        <div className="rounded-md border border-gray-200 bg-white p-3 mt-2 space-y-2 text-[11px]">
          ...
          <InfoRow label="Source" value="Trello · Backend Platform" />
          <InfoRow label="Days left" value={`${session.daysLeft}`} mono />
        </div>
      </div>
