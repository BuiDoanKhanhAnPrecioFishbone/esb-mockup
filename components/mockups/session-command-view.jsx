...
/* ═══ Session Command View — CL-119/120/127 + all fixes ═══
   Prepare phase · 3 roles · Right drawer Side Panel
   Fix1: module-level Q · Fix2: tab switch wired · Fix3: General bucket
   Fix4: OB logs filtered · CW+Manager can upload · 16 cards with rich data */
