...
/* ═══ Session Command View — CL-119/120/127 ═══
   ...
   File uploads: module headers (Manager) + answer attachments (Offboarder Capture) + Side Panel. */
...
const MODULES_DATA = [
  { board: "Backend Services", boardCards: 34, modules: [
    ...
    { name: "Shared Libraries", cards: 6, qs: 2, gaps: 0, items: [
      { name: "API key rotation", desc: "Scheduled rotation of API keys across services. Runs every 90 days via GitHub Action.", checklist: [{ text: "Rotation schedule documented", done: true }, { text: "Auto-rotation configured", done: true }], gaps: [], files: [{ name: "api-key-rotation.md", size: "1.8 KB", by: "System" }], qs: [{ q: "Where is the API key rotation runbook?", from: "AI-generated" }] },
    ]},
  ]},
