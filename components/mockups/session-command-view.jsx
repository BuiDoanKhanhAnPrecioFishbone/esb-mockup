...
function CardRow({ card, linked, showProgress, canManage, dismissedFlags, onDismissFlag, onRestoreFlag, primaryModuleOf, selectedCard, onSelectCard, clsFilter, clsOn, moduleName }) {
  ...
  return <div className={`group/row relative w-full flex items-start gap-2 pr-3 py-2 border-t border-gray-50 ${linked?"pl-7":"pl-10"} ${isSel?"bg-violet-50 border-l-2 border-l-violet-500":showSignal?cmeta.rowBg:"hover:bg-gray-50"}`} style={showSignal?{borderLeft:cmeta.rowBorder}:undefined}>
