...
/* Session Command View — CL-119/120/127/128/129
   ...
   Capture+: edit/delete hidden, answers shown. */
...
function SidePanel({ card, role, onClose, isCapture, isDeliver, isComplete }) {
  ...
  return <div className="p-5">
    ...
    {role!=="offboarder"&&!readOnly&&<button className="text-[10px] text-violet-600 inline-flex items-center gap-1 mt-1 hover:text-violet-700 cursor-pointer"><Upload className="w-2.5 h-2.5"/>Upload file</button>}
