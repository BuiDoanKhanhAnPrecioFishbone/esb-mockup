...
import {
  ...
  Network, Mic, Pause, Square, BookOpen, Award,
  TrendingUp, Check, X, MessageCircle, ChevronDown, Send,
  Flag, ArrowUpRight, Layers, FileText, GraduationCap,
  Compass, ShieldAlert
} from 'lucide-react';

const STATES = [
  { id: 1, num: '01', name: 'Khởi tạo Cẩm nang',     uc: 'UC-ON-01.AC.1', context: 'Cold Start' },
  { id: 2, num: '02', name: 'Đọc Cẩm nang',          uc: 'UC-ON-02',      context: 'Happy Path' },
  { id: 3, num: '03', name: 'Dữ liệu hạn chế',       uc: 'UC-ON-02.EX.4', context: 'RBAC Masking' },
  { id: 4, num: '04', name: 'Phỏng vấn AI',          uc: 'UC-HO-02',      context: 'Voice Interview' },
  { id: 5, num: '05', name: 'Khoảng cách kỹ năng',   uc: 'UC-ON-03',      context: 'Skill Gap' },
  { id: 6, num: '06', name: 'Duyệt sửa lỗi',         uc: 'UC-HO-06/07',   context: 'Diff Review' },
];
        ...
        <div className="flex items-center gap-1 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
          {STATES.map(s => {
            ...
            return (
              ...
              >
                <span className={`${isActive ? 'text-gray-400' : 'text-gray-400'} font-medium`} style={{ fontFamily: 'ui-monospace, Menlo, monospace' }}>{s.num}</span>
                <span>{s.name}</span>
              </button>
            );
          })}
    ...
    <div className="h-full flex overflow-hidden">
      ...
      >
        <div className="text-center">
          <Network className="w-8 h-8 text-gray-300 mx-auto mb-3" strokeWidth={1.5} />
          <p className="text-xs text-gray-400">Sơ đồ tri thức sẽ xuất hiện sau khi thiết lập</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-full flex overflow-hidden">
      ...
      <div style={{ width: '45%' }} className="bg-white border-r border-gray-200 flex flex-col overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-gray-200 shrink-0">
          <span className="text-[10px] uppercase tracking-[0.2em] text-gray-500 font-medium">Cẩm nang Hội nhập</span>
          <h1 className="text-xl font-semibold text-gray-900 mt-1.5 tracking-tight">Senior Backend Engineer</h1>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
          <div className="flex items-center gap-2 flex-wrap mb-1">
            ...
            >
              ...
              <span className="text-gray-600">Tạo bởi AI · Từ phỏng vấn bàn giao</span>
            </span>
            <span className="px-2.5 py-1 rounded text-[11px] border border-gray-200 bg-gray-50 text-gray-500">
              Cập nhật 2 giờ trước
            </span>
          </div>

          {/* Critical card - auto-expanded */}
            ...
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="flex items-center justify-between text-[11px]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-900">@nam.tran</span>
                  <span className="text-gray-300">·</span>
                ...
                <button className="flex items-center gap-1 px-2 py-0.5 rounded border border-gray-200 bg-white hover:bg-amber-50 hover:border-amber-300 hover:text-amber-700 text-gray-500 transition-colors">
        ...
        <div className="border-t border-gray-200 bg-white px-4 py-3 shrink-0">
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 bg-white">
            ...
            />
            <button className="px-2.5 py-1 rounded-md bg-gray-900 hover:bg-gray-800 text-white text-xs">
  ...
  return (
    <div className="h-full flex overflow-hidden">
      <div style={{ width: '45%' }} className="bg-white border-r border-gray-200 flex flex-col overflow-hidden">
        ...
        <div className="px-3 py-2 border-b border-gray-200 shrink-0 bg-gray-50/60">
          <div className="flex gap-1 overflow-x-auto" style={{ scrollbarWidth: 'none' }}>
            <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs border border-amber-300 bg-amber-50 text-amber-800">
              <ShieldAlert className="w-3 h-3" />
              <span>Dữ liệu nhạy cảm DB</span>
            </button>
            <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs border border-transparent text-gray-600">
              <Bug className="w-3 h-3" />
              <span>Nợ kỹ thuật</span>
            </button>
            <button className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs border border-transparent text-gray-600">
              <Users className="w-3 h-3" />
              <span>Mạng lưới nhân sự</span>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          <div className="rounded-lg border border-gray-200 bg-gray-50/60 p-6 text-center">
            ...
            <p className="text-xs text-gray-500 mb-1">
              Nội dung này yêu cầu cấp độ phân quyền cao hơn.
            </p>
      ...
      >
        ...
        <svg viewBox="0 0 800 560" className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="xMidYMid meet" style={{ top: 41 }}>
          {/* Edges - all dimmed */}
          <line x1="400" y1="290" x2="240" y2="190" stroke="#d4d4d8" strokeWidth="1" strokeDasharray="3 3" />
          <line x1="400" y1="290" x2="240" y2="400" stroke="#d4d4d8" strokeWidth="1" strokeDasharray="3 3" />
          <line x1="400" y1="290" x2="580" y2="190" stroke="#d4d4d8" strokeWidth="1" strokeDasharray="3 3" />
          <line x1="400" y1="290" x2="580" y2="400" stroke="#d4d4d8" strokeWidth="1" strokeDasharray="3 3" />

          {/* Satellite nodes */}
          {[
            { x: 240, y: 190, label: 'config-svc', kind: 'dịch vụ' },
            { x: 240, y: 400, label: 'audit-log',  kind: 'dịch vụ' },
            { x: 580, y: 190, label: 'admin-panel',kind: 'công cụ' },
            { x: 580, y: 400, label: 'secrets-mgr',kind: 'công cụ' }
          ].map((n, i) => (
          ...
          <g transform="translate(400, 290)">
            <circle cx="0" cy="0" r="32" fill="#f4f4f5" stroke="#a1a1aa" strokeWidth="1.5" strokeDasharray="4 3" />
            <g transform="translate(0, -2)">
              {/* Padlock body */}
              <rect x="-9" y="-2" width="18" height="14" rx="2" fill="#71717a" />
              {/* Padlock shackle */}
              <path d="M -6 -2 L -6 -7 Q -6 -12 0 -12 Q 6 -12 6 -7 L 6 -2" fill="none" stroke="#71717a" strokeWidth="2.5" strokeLinecap="round" />
            </g>
            <text x="0" y="50" textAnchor="middle" fill="#71717a" fontSize="11" fontWeight="600">Bị giới hạn</text>
            <text x="0" y="63" textAnchor="middle" fill="#a1a1aa" fontSize="9">RBAC · cấp độ 4</text>
          </g>
        </svg>

        <div className="absolute bottom-3 right-3 px-2.5 py-1 rounded border border-gray-200 bg-white/90 text-[10px] text-gray-500">
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="text-center mb-8">
            <div className="relative inline-flex items-center justify-center mb-4">
              <div className="absolute inset-0 rounded-full bg-rose-100 animate-pulse" style={{ width: '88px', height: '88px', margin: 'auto', top: 0, left: 0, right: 0, bottom: 0 }} />
              <div className="relative w-22 h-22 rounded-full bg-rose-50 border-2 border-rose-200 flex items-center justify-center" style={{ width: '88px', height: '88px' }}>
                <Mic className="w-9 h-9 text-rose-500" strokeWidth={2} />
              </div>
            </div>
...
/* ═══════════════════════════════════════════════════
   STATE 5 — SKILL GAP ANALYSIS  (UC-ON-03)
   ═══════════════════════════════════════════════════ */
function SkillGapState() {
  ...
  const courses = [
    { title: 'Advanced Go for Backend Engineers', dur: '4 tuần', addr: 'Go programming',           src: 'Coursera · Internal' },
  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        <div className="mb-6">
          <span className="text-[10px] uppercase tracking-[0.2em] text-gray-500 font-medium">Hội nhập</span>
          <h1 className="text-2xl font-semibold text-gray-900 mt-1 tracking-tight">Phân tích khoảng cách kỹ năng</h1>
          <p className="text-sm text-gray-600 mt-1">
            So sánh với hồ sơ của <span className="text-gray-900 font-medium">@minh.le</span> (người tiền nhiệm cho vai trò Senior Backend Engineer)
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="rounded-lg border border-gray-200 bg-white px-4 py-3">
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-emerald-700 font-medium">
              <Check className="w-3 h-3" />
              Khớp
            </div>
            <div className="text-2xl font-semibold text-gray-900 mt-1">2</div>
            <div className="text-[11px] text-gray-500">kỹ năng đạt yêu cầu</div>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white px-4 py-3">
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-amber-700 font-medium">
              <TrendingUp className="w-3 h-3" />
              Khoảng cách
            </div>
            <div className="text-2xl font-semibold text-gray-900 mt-1">3</div>
            <div className="text-[11px] text-gray-500">cần được nâng cao</div>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white px-4 py-3">
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.18em] text-gray-700 font-medium">
              <Award className="w-3 h-3" />
              Vượt trội
            </div>
            <div className="text-2xl font-semibold text-gray-900 mt-1">1</div>
            <div className="text-[11px] text-gray-500">điểm mạnh bổ sung</div>
          </div>
        </div>
...
function SkillRow({ name, required, current, level }) {
  const reqW = (required / 5) * 100;
  const curW = (current / 5) * 100;
  const tag = level === 'gap'
  ...
  return (
    <div className="px-4 py-3">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className={`text-[10px] px-1.5 py-0.5 rounded border uppercase tracking-wider font-semibold ${tag.cls}`}>
          {tag.text}
        </span>
      </div>
      <div className="space-y-1.5">
        <div className="flex items-center gap-2 text-[10px]">
          <span className="w-14 text-gray-500">Yêu cầu</span>
          <div className="flex-1 h-1.5 rounded-full bg-gray-100 overflow-hidden">
            <div className="h-full bg-gray-300" style={{ width: `${reqW}%` }} />
          </div>
          <span className="w-3 text-right text-gray-500" style={{ fontFamily: 'ui-monospace, Menlo, monospace' }}>{required}</span>
        </div>
        <div className="flex items-center gap-2 text-[10px]">
          <span className="w-14 text-gray-500">Hiện tại</span>
          <div className="flex-1 h-1.5 rounded-full bg-gray-100 overflow-hidden">
            <div className="h-full bg-gray-900" style={{ width: `${curW}%` }} />
          </div>
          <span className="w-3 text-right text-gray-700" style={{ fontFamily: 'ui-monospace, Menlo, monospace' }}>{current}</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-full overflow-y-auto bg-gray-50">
      <div className="max-w-5xl mx-auto p-6">
        ...
        {/* Header */}
        <div className="mb-5">
          <span className="text-[10px] uppercase tracking-[0.2em] text-gray-500 font-medium">Báo cáo nội dung sai</span>
        ...
        <div className="rounded-lg border border-gray-200 bg-white px-4 py-3 mb-4 flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3 text-xs text-gray-600 flex-wrap">
            <span className="flex items-center gap-1.5">
              ...
              <span className="text-gray-900 font-medium">@minh.le</span>
            </span>
            <span className="text-gray-300">·</span>
            <span>2 giờ trước</span>
            <span className="text-gray-300">·</span>
            <span>Phân hệ: <span className="text-gray-700">Nợ kỹ thuật & Bugs</span></span>
            <span className="text-gray-300">·</span>
            <span style={{ fontFamily: 'ui-monospace, Menlo, monospace' }}>BUG-404</span>
          </div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 mb-5">
          <div className="text-[10px] uppercase tracking-[0.18em] text-gray-500 font-medium mb-2">Lý do (từ người dùng)</div>
          <p className="text-sm text-gray-700 leading-relaxed">
        ...
        <div className="rounded-lg border border-gray-200 bg-gray-50/60 p-4 mb-5">
          <div className="text-[10px] uppercase tracking-[0.18em] text-gray-500 font-medium mb-2 flex items-center gap-1.5">
            ...
            Ảnh hưởng nếu chấp nhận
          </div>
          <div className="grid grid-cols-3 gap-3 text-xs">
            <div>
              <div className="text-gray-500 text-[11px]">Node Knowledge Graph</div>
              <div className="text-gray-900 font-medium mt-0.5">1 node cập nhật</div>
            </div>
            <div>
              <div className="text-gray-500 text-[11px]">Phụ thuộc</div>
              <div className="text-gray-900 font-medium mt-0.5">2 cẩm nang liên quan</div>
            </div>
            <div>
              <div className="text-gray-500 text-[11px]">Vòng học chủ động</div>
              <div className="text-gray-900 font-medium mt-0.5">Có · sẽ tinh chỉnh</div>
            </div>
          </div>
        </div>
...
/* ═══════════════════════════════════════════════════
   SHARED — GRAPH PANEL (for State 2)
   ═══════════════════════════════════════════════════ */
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 800 560" className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="xMidYMid meet" style={{ top: 41 }}>
        ...
        {/* Edges */}
        <line x1="400" y1="280" x2="240" y2="180" stroke="#f59e0b" strokeWidth="1.2" strokeOpacity="0.7" />
        <line x1="400" y1="280" x2="240" y2="390" stroke="#f59e0b" strokeWidth="1.2" strokeOpacity="0.7" />
        <line x1="400" y1="280" x2="580" y2="180" stroke="#f59e0b" strokeWidth="1.2" strokeOpacity="0.7" />
        <line x1="400" y1="280" x2="580" y2="390" stroke="#f59e0b" strokeWidth="1.2" strokeOpacity="0.7" />
        <line x1="400" y1="280" x2="400" y2="470" stroke="#f59e0b" strokeWidth="1.2" strokeOpacity="0.7" />
